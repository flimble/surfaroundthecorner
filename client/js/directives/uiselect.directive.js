  ...
  function(uiSelectConfig, RepeatParser, uiSelectMinErr, $compile) {
    ...
    return {
      ...
      templateUrl: function(tElement) {
        ...
        return 'views/' + theme + '/choices.tpl.html';
      },
  ...
  function($document, uiSelectConfig, uiSelectMinErr, uisOffset, $compile, $parse, $timeout) {
    ...
    return {
      ...
      templateUrl: function(tElement, tAttrs) {
        ...
        return 'views/' + theme + (angular.isDefined(tAttrs.multiple) ? '/select-multiple.tpl.html' : '/select.tpl.html');
      },
      replace: true,
      transclude: true,
...
uis.directive('uiSelectMatch', ['uiSelectConfig', function(uiSelectConfig) {
  return {
    ...
    templateUrl: function(tElement) {
      ...
      return 'views/' + theme + (multi ? '/match-multiple.tpl.html' : '/match.tpl.html');
    },
...
uis.service('uisRepeatParser', ['uiSelectMinErr', '$parse', function(uiSelectMinErr, $parse) {
  ...
  /**
   * Example:
   * expression = 'address in addresses | filter: {street: $select.search} track by $index'   * itemName = 'address',
