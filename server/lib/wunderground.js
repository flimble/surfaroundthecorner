...
var wunderground = function (apikey, debug, rateCount, rateTime) {
    ...
    var that = this;
    var format = '.json';
    console.log('WunderGroundClient initialized, apikey: ' + apikey + ', debug enabled: ' + debug + ', rateCount: ' + rateCount + ', rateTime: ' + rateTime);
